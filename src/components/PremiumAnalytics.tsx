          ...
          <CardContent>
            <div className="flex items-center gap-6">
              <div className="relative w-28 h-28">
                <svg className="w-28 h-28 transform -rotate-90">
                  ...
                  <circle
                    ...
                    strokeWidth="8"
                    fill="none"
                    strokeDasharray={`${(recoveryScore.overall / 100) * 301.6} 301.6`}
                    strokeLinecap="round"
                  />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-3xl font-bold">{recoveryScore.overall}</span>
              ...
              <div className="flex-1 space-y-2">
                {[
                  { label: "Emotional", value: recoveryScore.emotional, icon: Heart, color: "bg-pink-500" },
                  { label: "Behavioral", value: recoveryScore.behavioral, icon: Shield, color: "bg-emerald-500" },
                  { label: "Physical", value: recoveryScore.physical, icon: Moon, color: "bg-blue-500" },
                  { label: "Consistency", value: recoveryScore.social, icon: Activity, color: "bg-amber-500" },
                ].map(item => (
